            ...
            case 'current':
                ...
                foreach ($divs as $div) {
                    ...
                    if ($time and $room and $title and $lecturer) {
                        ...
                        // link to floorplan
                        $linkString = StaticMethods::getLinkForRoom($entry['raum']);                        
                        
                        // add entries into the result structure
                        $entries[] = array(
                            'title' => $entry['titel'],
                            'subtitle' => $entry['zeit'] . " / " . $entry['dozent'] . '<br/>' .  $linkString 
                        );
            ...
            case 'public':
                ...
                foreach($events as $event){
                    ...
                    foreach($contents as $content){
                        ...
                        $linkString = StaticMethods::getLinkForRoom($room);      
                        
                        $entries[] = array(
                            'title' => $title,
                            'subtitle' => $start . "-" . $end . " / "  . $speaker . "<br/>" . $linkString
                        );
                    }
                }
