...
class TransitWebModule extends WebModule {
    ...
    */
    ...
    protected function initializeForPage() {
        ...
        switch ($this->page) {
            ...
            case 'transport':
                 ...
                 */
                if ($fromtoPost == "Nach") {
                    $url = $baseUrl . $this->replaceSpecialChars($placePost) . "/" . $university . "?";
                } else if ($fromtoPost == "Von") {
                    $url = $baseUrl . $university . "/" . $this->replaceSpecialChars($placePost) . "?";
                } else {
                    //fatal error
                }
    ...
    private function replaceSpecialChars($place){
