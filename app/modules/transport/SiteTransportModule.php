 ...
 * @author flo
 */
class SiteTransportModule extends Module {
    ...
    protected function initializeForPage() {
        ...
        switch ($this->page) {
            ...
            case 'form':
                ...
                foreach ($fromtoModuleArray as $entryFT) {
                    $fromtoOptions[] = $counter;
                    $fromto[] = $entryFT['fromto'];
                    $counter++;
                }
                ...
                $this->assign('counterFt', $fromtoOptions);
            ...
            case 'busschedule':
                ...
                $url_bus9 = "http://fahrplan.search.ch/st.gallen,gatterstrasse-universitaet-west";
            ...
            case 'transport':
                 ...
                 */
                if ($fromtoPost[0] == "0") {
                    $url = $baseUrl . $placePost . "/" . $university . "?";
                } else if ($fromtoPost[0] == "1") {
                    $url = $baseUrl . $university . "/" . $placePost . "?";
                } else {
                    //fatal error
                }
                ...
                $title = preg_replace ("/ \[fahrplan.search.ch\]/" , "" , $title);
                ...
                foreach ($allTables as $table) {
                    ...
                    if ($classMainTable == "oev_compact") {
                        ...
                        // Variables to cumulate changes and walks
                        ...
                        foreach ($tableRows as $tableRow) {
                            ...
                            foreach ($tableColumns as $tableColumn) {
                                ...
                                if (strlen(strstr($class, 'oev_tripoverview')) > 0) {
                                    $timeMainInfo = $tableColumn->nodeValue;
                                    $isset_time = true;
                            ...
                            if ($isset_detail && $isset_duration && $isset_time && $isset_transport) {
                                ...
                                $entries[] = array(
                                    ...
                                    'subtitle' => "Umsteigen: " . ($change - 1) . " / Fussweg: " . $walk . "'",
                                    'url' => $urlDetail
                                );
